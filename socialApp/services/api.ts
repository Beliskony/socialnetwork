...
//Pour Story
export const createStory = (user: string) => axios.post(`${BASE_URL}/story/create/${user}`)
export const deleteStory = (user: string, story: string) => axios.delete(`${BASE_URL}/story/delete/${user}/${story}`)
