// hooks/useStories.ts - VERSION CORRIGÉE
...
export const useStories = () => {
  ...
  // ✅ CORRECTION : Sélecteurs utilisés directement avec useSelector
  ...
  const unviewedCount = useSelector(selectUnviewedStoriesCount);
  const activeStories = useSelector(selectActiveStories);
  const groupedStories = useSelector(selectStoriesGroupedByUser);
